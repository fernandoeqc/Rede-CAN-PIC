...
/* unsigned int bloqueio(tempoSemComunicacao)
{
   if(tempoSemComunicacao > 60)
   {
...
void main()
{
   unsigned int8 tempoUltimaMsg = 0, msgRecebida = 0;
   //VEJA placa_plus.h
